  ...
  render() {
    return (
      ...
      <Toolbar>
          ...
          {this.props.currentUser ? <Button startIcon={<ExitToAppIcon />} variant="outlined" color="inherit" onClick={this.props.logOut}> <Link to="/">LogOut</Link></Button> : <Button startIcon={<AccountCircleIcon />} variant="outlined" color="inherint"><Link to="/login">Login</Link></Button>}
